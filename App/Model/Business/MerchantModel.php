...
class MerchantModel extends MysqlModel
{
    ...
    public function getDDL() {
        $sql = DDLBuilder::table($this->tableName, function (Table $table) {
            ...
            $table->colTinyInt('status')->setIsNotNull(true)->setColumnLimit(1)->setDefaultValue('0')->setColumnComment("商家状态 0待审核 1审核不通过 2审核通过 .....");
            ...
            $table->indexUnique('app_uid', ['app', 'mid']);
        });
